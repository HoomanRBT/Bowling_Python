...
result = 'Pin_Is_OK'
if result is None:
    connection = MySQLdb.connect(host="192.168.1.117",    # your host, usually localhost
                     user="hamed",         # your username
                     passwd="%Hmd0914%",  # your password
                     db="bowling")        # name of the data base
...
if result is None:
    ...
    set_line_bounds()
    sql = f"""UPDATE bowling.ball_line_location SET line_box = 
